...
public class BreakAnimationListener implements ChestListener {

    private final Plugin plugin;
    private final AnimationService service;
    private final BreakAnimationOptions options;

    public BreakAnimationListener(Plugin plugin, AnimationService service, BreakAnimationOptions options) {
        this.plugin = plugin;
