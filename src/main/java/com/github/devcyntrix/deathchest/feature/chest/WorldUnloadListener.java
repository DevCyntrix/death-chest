...
public class WorldUnloadListener implements Listener {
    ...
    public WorldUnloadListener(DeathChestPlugin plugin) {
        this.plugin = plugin;
    }

    @EventHandler
    public void onWorldLoad(WorldLoadEvent event) {
        plugin.getDeathChestService().loadChests(event.getWorld());
    }

    @EventHandler
    public void onWorldUnload(WorldUnloadEvent event) {
        plugin.getDeathChestService().unloadChests(event.getWorld(), true);
    }
