...
public class SpawnChestListener implements Listener {
    ...
    public void onDeath(PlayerDeathEvent event) {
        ...
        } else if (Objects.equals(player.getLocation().getWorld(), lastSafePos.getWorld())
                && horizontalDistanceSquared(player.getLocation(), lastSafePos) >= 20 * 20) {
    ...
    private double horizontalDistanceSquared(Location location, Location location1) {
        return NumberConversions.square(location.getX() - location1.getX()) + NumberConversions.square(location.getZ() - location1.getZ());
    }
