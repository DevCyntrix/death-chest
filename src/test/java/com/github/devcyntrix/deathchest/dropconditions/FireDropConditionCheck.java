...
@DisplayName("Fire drop condition check")
public class FireDropConditionCheck {
    ...
    public void doesntDropItemsInLava() {
        InputStream stream = getClass().getClassLoader().getResourceAsStream("drop-conditions/fire-drop.yml");
    ...
    @Test
    @DisplayName("Doesn't drop items if player dies in void")
    public void doesntDropItemsInVoid() {
        InputStream stream = getClass().getClassLoader().getResourceAsStream("drop-conditions/fire-drop.yml");
        if (stream == null) throw new IllegalStateException("Missing config");
    ...
    @Test
    @DisplayName("Drop items if player dies in fire")
    public void dropItemsInFire() {
        InputStream stream = getClass().getClassLoader().getResourceAsStream("drop-conditions/fire-drop.yml");
        if (stream == null) throw new IllegalStateException("Missing config");
