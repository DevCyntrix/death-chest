...
@DisplayName("Lava drop condition check")
public class LavaDropConditionCheck {
    ...
    @Test
    @DisplayName("Drop items if player dies in lava")
    public void dropItemsInLava() {
        InputStream stream = getClass().getClassLoader().getResourceAsStream("drop-conditions/lava-drop.yml");
